...
class Key{
	static final int HOME = Integer.MIN_VALUE +1;
	static final int INS = Integer.MIN_VALUE +2;
	static final int SUPR = Integer.MIN_VALUE +3;
	static final int END = Integer.MIN_VALUE +4;
	static final int RIGHT = Integer.MIN_VALUE +5;
	static final int LEFT = Integer.MIN_VALUE +6;
	static final int OVERWRITE = Integer.MIN_VALUE +7;
...
public class EditableBufferedReader extends BufferedReader {
    ...
    protected void setRaw(){
       try{
            ...
            System.out.println("CANVIAT A RAW");
    ...
    public void unsetRaw() {
        try {
            ...
            Runtime.getRuntime().exec(cmd);
            System.out.println("CANVIAT A ORIGINAL");
        } catch (IOException e) {
